...
## Usage
Now that I have worked with React and have multiple projects to share, I have updated my portfolio and other materials to build toward being employer competitive. Creating a portfolio using React will help deomstrate some of the latest technologies.
...
This updated site has all of the content it previously had:
...
* A list of projects. For each project, they have the following:
...
* A unique color palette. It doesn't just look like
the default bootstrap theme or an unstyled HTML site. 

* The font size is large enough to read, and the colors don't cause eye strain.

* This portfolio was built using Materialize and React component libraries. 

### Updated LinkedIn Profile 

Make sure to visit my [LinkedIn Profile](linkedin.com/in/dean-warren-ab01468) with the new skills I've acquired since the last time it was updated.
