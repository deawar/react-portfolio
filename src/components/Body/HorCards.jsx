                                ...
                                <div className="card hoverable">
                                    <div className="card-image">
                                        ...
                                        <div className="container left-align flow-text">                                
                                            <p className="light">Why do I feel so dumb?</p>
                                            <p>I am in the process of a career transition. I am going to school. Working very hard to learn and absorb all that I am being taught. Struggling with assignments and projects and at times feeling as though I haven't moved. The truth is I have moved, I have learned, and I have improved my skills, not a little, but by leaps and bounds. I think my problem is one of perception. I am comparing myself to others who have been coding and learning intensely for years and I wonder why I am still not on par with them. As any good Full Stack Dev does I googled the problem and came across an interesting article that really applies to my current situation and maybe to yours as well if you are trying to learn something new. The funny part is that it came from a totally unexpected source, learning to dance at the <a href="https://www.arthurmurraydancing.com/dance-blog/5-ways-to-tell-if-youre-making-progress" target="_blank" rel="noopener noreferrer" alt="Arthur Murray Dance Center Website">Arthur Murray Dance Center Website</a> in the section headed <i>5 Ways to tell if you're making progress</i> by Juan de Dios Garcia. If the link doesn't get you to the site then search for <i>5 Ways to tell if you're making progress.</i></p>
                                            <p>A quick recap of the article is this: We are our own worst critic. This certainly applies to me. The author goes on to say, "Everyone expects to see results just after one week going to the gym. However, every trainer will tell you, it doesn't work that way. Results take time and so does progress." I have tried to learn ballroom dancing and it was hard. Here are the 5 tips stolen from this article that I find have also applied to my Full Stack Dev learning process:</p>
                                            <p>1. IT'S EASIER. Repetition is the key to getting your mind to remember what to do. The more you do it, the easier it gets. When a process for setting up an application or writing a JavaScript function gets easier to remember, that is a sure sign you are getting it. It is an indication that you are on your way to understanding that piece.</p>
                                            <p>2. IT'S HARDER. In my Full Stack Dev course, each week has been much more challenging than the last. The instructor,<a href="http://linkedin.com/in/esterling-accime-324a4181" target="_blank" rel="noopener noreferrer">Esterling Accime</a>, pushes us to try new technologies at every turn. Try the hard stuff. Learn how to ask questions and research. Why, because he knows we are ready to progress to the next level.</p>
                                            <p>3. GOOD JOB. When you are progressing others will probably notice before you do. Sometimes it's as if you are fish not realizing you live in water. Our progress can be similar. You might only be able to tell by the compliments you get. Compliments like Way to Go! and Good Job! are not nearly as empty as we may think because these can indicate that, yes, you have made some progress. It can be hard to accept compliments. Just say, Thank you! It is the easiest way to accept. If you really want to know why you might ask, "Why do you think I did a good job?" The answer should prove that you are moving in the right direction.</p>
                                            <p>4. PICTURE PERFECT As a developer, the goal is to create products and websites, whether personal projects or professional ones. A quick review of an earlier project can tell you a lot. You either like it or not. If you review a past project and say, "What the heck was I thinking!?!" That is a concrete sign you have progressed.</p>
                                            ...
                                            <p>The learning process is as much about learning about yourself as it is progression. I found all these points applied to me and it made me realize, while I have a long way to go, I have definitely made progress. The challenge now is to make the progress a sustainable practice and to stay consistent in learning. I hope this gives you hope that you are in fact learning and progressing as well!</p>
                                        </div>
                                ...
                                <div className="card hoverable">
                                    ...
                                    <div className="card-stacked">
                                        <div className="card-content left-align flow-text">
                                            ...
                                            Tip: You can use the commands <b>docker images</b> or the newer <b>docker image ls</b> to list images. They give you the same output.</p> 

                                            <h4>Run the app</h4>

                                            <p>Run the app, mapping your machine’s port 4000 to the container’s published port 80 using -p: <br/><br/>
